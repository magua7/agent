...
- [1. Web Server Parsing Vulnerabilities](#1-web-server-parsing-vulnerabilities)
- [2. PUT Method Exploitation](#2-put-method-exploitation)
- [3. CVE Case: WebLogic Arbitrary File Upload (CVE-2018-2894)](#3-cve-case-weblogic-arbitrary-file-upload-cve-2018-2894)
- [4. CVE Case: Apache Flink File Upload (CVE-2020-17518)](#4-cve-case-apache-flink-file-upload-cve-2020-17518)
- [5. File Upload + Parsing Vulnerability Chain](#5-file-upload-parsing-vulnerability-chain)
- [6. Extension Bypass Reference](#6-extension-bypass-reference)
<!-- zhiyugo:toc:end -->
