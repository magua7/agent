# SKILL: OS Command Injection — Expert Attack Playbook: detailed technique reference
...
- [5. PAYLOAD LIBRARY](#5-payload-library)
- [6. FILTER BYPASS TECHNIQUES](#6-filter-bypass-techniques)
- [7. COMMON INJECTION ENTRY POINTS](#7-common-injection-entry-points)
- [8. BLIND INJECTION DECISION TREE](#8-blind-injection-decision-tree)
- [9. ADVANCED WAF BYPASS TECHNIQUES](#9-advanced-waf-bypass-techniques)
- [10. PHP disable_functions BYPASS PATHS](#10-php-disablefunctions-bypass-paths)
- [11. COMPONENT-LEVEL COMMAND INJECTION](#11-component-level-command-injection)
- [12. WINDOWS CMD.EXE VS POWERSHELL INJECTION MATRIX](#12-windows-cmdexe-vs-powershell-injection-matrix)
- [13. CONTAINER / K8S EXEC INJECTION](#13-container-k8s-exec-injection)
- [14. ENVIRONMENT VARIABLE INJECTION](#14-environment-variable-injection)
<!-- zhiyugo:toc:end -->
