...
- [1. CVE Case: Maccms 8.x PHP Template Eval](#1-cve-case-maccms-8x-php-template-eval)
- [2. CVE Case: Atlassian Jira SSTI (CVE-2019-11581)](#2-cve-case-atlassian-jira-ssti-cve-2019-11581)
- [3. Spring Cloud Gateway SpEL Injection (CVE-2022-22947)](#3-spring-cloud-gateway-spel-injection-cve-2022-22947)
- [4. Struts2 OGNL → RCE (S2-045 / CVE-2017-5638)](#4-struts2-ognl-rce-s2-045-cve-2017-5638)
- [5. Confluence OGNL Injection (CVE-2021-26084)](#5-confluence-ognl-injection-cve-2021-26084)
- [6. SSTI vs EL Injection — When to Cross-Reference](#6-ssti-vs-el-injection-when-to-cross-reference)
- [7. Additional Template Engines — ASP.NET Razor](#7-additional-template-engines-aspnet-razor)
- [8. Additional Template Engines — Elixir EEx/LEEx/HEEx](#8-additional-template-engines-elixir-eexleexheex)
- [9. Additional Template Engines — PHP Engines](#9-additional-template-engines-php-engines)
- [10. Additional Template Engines — JavaScript Stack](#10-additional-template-engines-javascript-stack)
- [11. Universal SSTI Detection & Blind Techniques](#11-universal-ssti-detection-blind-techniques)
<!-- zhiyugo:toc:end -->
...
Also see the dedicated `expression-language-injection` skill for SpEL/OGNL deep dives.
...
Also see `expression-language-injection` for the full OGNL treatment.
