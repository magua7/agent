# SKILL: Path Traversal / Local File Inclusion (LFI) — Expert Attack Playbook: detailed technique reference
...
- [4. PHP LFI → RCE TECHNIQUES](#4-php-lfi-rce-techniques)
- [5. PHP FILTER WRAPPER (FILE CONTENT READ)](#5-php-filter-wrapper-file-content-read)
- [6. REMOTE FILE INCLUSION (RFI) — WHEN ENABLED](#6-remote-file-inclusion-rfi-when-enabled)
- [7. SERVER-SPECIFIC PATH TRUNCATION](#7-server-specific-path-truncation)
- [8. PARAMETER LOCATIONS TO TEST](#8-parameter-locations-to-test)
- [9. FILTER BYPASS CHECKLIST](#9-filter-bypass-checklist)
- [10. IMPACT ESCALATION PATH](#10-impact-escalation-path)
- [11. LFI TO RCE ESCALATION PATHS](#11-lfi-to-rce-escalation-paths)
- [12. PHP WRAPPER EXPLOITATION MATRIX](#12-php-wrapper-exploitation-matrix)
- [13. PEARCMD LFI EXPLOITATION](#13-pearcmd-lfi-exploitation)
- [14. WINDOWS-SPECIFIC LFI TECHNIQUES](#14-windows-specific-lfi-techniques)
- [15. PARAMETER NAMING PATTERNS (HIGH-FREQUENCY TARGETS)](#15-parameter-naming-patterns-high-frequency-targets)
- [16. LFI TO RCE — ESCALATION PATHS](#16-lfi-to-rce-escalation-paths)
- [17. PHP WRAPPER EXPLOITATION MATRIX](#17-php-wrapper-exploitation-matrix)
- [18. PEARCMD LFI TO RCE](#18-pearcmd-lfi-to-rce)
- [19. PARAMETER NAMING PATTERNS & HIGH-FREQUENCY ENDPOINTS](#19-parameter-naming-patterns-high-frequency-endpoints)
- [20. JAVA / SPRING PATH TRAVERSAL](#20-java-spring-path-traversal)
- [21. TOMCAT-SPECIFIC TRICKS](#21-tomcat-specific-tricks)
- [22. NGINX ALIAS MISCONFIGURATION](#22-nginx-alias-misconfiguration)
- [23. NODE.JS PATH MODULE QUIRKS](#23-nodejs-path-module-quirks)
- [24. IIS SHORT FILENAME ENUMERATION (~1 TILDE TRICK)](#24-iis-short-filename-enumeration-1-tilde-trick)
<!-- zhiyugo:toc:end -->
