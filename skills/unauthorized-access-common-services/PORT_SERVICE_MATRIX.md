...
- [Port 110/143 — POP3/IMAP](#port-110143-pop3imap)
...
- [Port 8080 — Tomcat / Jenkins](#port-8080-tomcat-jenkins)
...
See `active-directory-kerberos-attacks` for full Kerberos attack playbook.
